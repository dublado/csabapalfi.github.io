...
If I understood well on **iOS** we can use **[QML](http://en.wikipedia.org/wiki/QML)** as part of [Qt](http://qt.digia.com/). It allows you to **bind properties** to another and have them automatically change when a referenced property changes. It has a declarative language (with a JavaScript-like syntax) to define property bindings.
